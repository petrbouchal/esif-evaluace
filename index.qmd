...
get_icons <- function(filename) {
  ...
  iconname <- case_when(grepl("příloh|priloh", filename) ~ "paperclip",
                        ...
                        grepl("csv|xls", filename) ~ "file-csv",
                        ...
                        grepl("případ|pripad", filename) ~ "location-crosshairs",
      ...
      tags$div(
        ...
        tags$div(
          ...
          purrr::pmap(list(odkazy$file_url, odkazy$file_text, odkazy$link), function(x, y, link) 
            if(is.na(x)) NULL else tags$div(get_icons(y),
                                            tags$a(get_base_name(y), href = x), 
                                            if(is_english(y)) tagList(tags$span(" "), fa_i("globe")),
                                            if(is_kraj(y)) tagList(tags$span(" "), fa_i("map-location-dot")),
